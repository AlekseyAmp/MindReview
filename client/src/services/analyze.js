...
export async function analyzeTest(reviews, setError, setShowError, setSuccess, setShowSuccess) {
    try {
...
export async function uploadFile(user_id, file, setError, setShowError, setSuccess, setShowSuccess, setIsLoadAnalyze) {
    try {
...
export function downloadAnalyzeResult(analyze_id, dt, setError, setShowError, setSuccess, setShowSuccess) {
    try {
        axios.get(`analyze/download/${analyze_id}`, {
