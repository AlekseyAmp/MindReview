...
function PieChart({ data }) {
    ...
    const chartData = [["Настроение", "Количество", { role: "tooltip", type: "string", p: { html: true } }]];
    ...
    const options = {
        ...
        colors: colorsMap.map(colorItem => data.sentiments[colorItem.sentiment] ? colorItem.color : '#000').filter(color => color !== '#000'),
